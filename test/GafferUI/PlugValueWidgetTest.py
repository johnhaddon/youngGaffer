...
column.pack_start( floatPlugWidget.getGTKWidget(), False )
column.pack_start( floatPlugWidget2.getGTKWidget(), False )
column.pack_start( intPlugWidget.getGTKWidget(), False )
column.pack_start( intPlugWidget2.getGTKWidget(), False )
column.pack_start( stringPlugWidget.getGTKWidget(), False )
column.pack_start( stringPlugWidget2.getGTKWidget(), False )
